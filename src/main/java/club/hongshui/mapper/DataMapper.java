...
public interface DataMapper {
    @Select("SELECT baqiao FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> bqselect();
    @Select("SELECT chiyang FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> cyselect();
    @Select("SELECT beishan FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> bsselect();
    @Select("SELECT shuangfeng FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> sfselect();
    @Select("SELECT panlong FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> plselect();
    @Select("SELECT zhongshan FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> zsselect();
    @Select("SELECT maanshan FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> masselect();
    @Select("SELECT xianyuan FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> xyselect();
    @Select("SELECT baixiang FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> bxselect();
    @Select("SELECT jiyunhedao FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> jyselect();
    @Select("SELECT huzhenhedao FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> hzselect();
    @Select("SELECT dongfanghedao FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
    List<String> dfselect();
    @Select("SELECT xianduhedao FROM data WHERE year=2021 AND month=7 AND (day=26 OR day=25 AND time >8 )")
